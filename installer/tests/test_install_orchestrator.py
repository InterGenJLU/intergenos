...
class _RunInstallTestBase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.packages.compute_install_set_gap.return_value = []
...
class TestRunInstallHappyPath(_RunInstallTestBase):
    ...
    def test_full_pipeline_efi_calls_each_backend_in_order(self):
        ...
        # Greeter monitor-layout sync (decided 2026-07-21): PHASE_SERVICES
        # enables the templated instance for the wizard-created user.
        self.users.enable_greeter_monitor_sync.assert_called_once()
        _sync_args = self.users.enable_greeter_monitor_sync.call_args
        self.assertEqual(_sync_args.args[1], "user")
