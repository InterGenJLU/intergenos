...
#   /usr/lib/intergenos/checks/{pkm,signing,boot,services,hardware}.sh
...
# SMOKE_RESULTS tally by lib.sh). The gaming and chronicle categories
# self-gate on their (optional) package being installed (one explicit SKIP
# otherwise — RT-2/RT-11).
# ---------------------------------------------------------------------------
