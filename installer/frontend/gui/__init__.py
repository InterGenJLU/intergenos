...
The 9-screen flow (Q-GUI-SCREENS resolved 2026-05-06 as seven; Packages
added 2026-05-16, Graphics & compute added 2026-08-05):

    Welcome → Keyboard/Locale/Timezone → Disk → User → Packages → Graphics
