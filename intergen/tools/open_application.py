...
class OpenApplicationTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            "Launch an installed desktop APPLICATION by name (searches "
            ".desktop files), or list the installed desktop applications. Use "
            "this only for GUI applications — not for systemd services (use "
            "manage_services) or software packages (use manage_packages)."
        )
