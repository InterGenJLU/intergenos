...
class AnalyzeFileTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            "Read a file and INTERPRET it — explain a config file, diagnose a "
            "log, summarize a script, or answer a specific question about what "
            "a file means or why it is failing. Use this when the user wants "
            "understanding, not just the text. For the raw verbatim contents "
