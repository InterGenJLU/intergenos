...
#
#   * IconTheme=InterGenOS        from packages/desktop/intergenos-icon-theme
...
# in-house; no upstream attribution.
#
...
do_install() {
    ...
    for f in index.theme gtk-3.0/gtk.css gtk-4.0/gtk.css gnome-shell/gnome-shell.css gnome-shell/greeter-background.png ; do
