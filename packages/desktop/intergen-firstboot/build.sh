...
#
# Q5 design properties are LOCKED per the decision of 2026-05-20T~19:Z: sweep
...
# Decided 2026-05-21T~01:Z).
#
# Legacy C/DRM source backends at assets/intergen-firstboot{,-drm}/ were
# removed 2026-05-22 per Q6 post-testing-cleanup verdict + audit-row D-011
# closure (v7-arc shipping extension is canonical; testing condition met
# via operator visual sign-off twice end-to-end on real hardware
# 2026-05-21). The Python reference at assets/intergen-firstboot-py/ stays
# in tree as the surviving canonical math reference per Q6 fallback
# preservation; the gnome-shell extension at intergen-firstboot@intergenos
# .org/ inside this same assets/intergen-firstboot/ directory is what
# ships to /usr/share/gnome-shell/extensions/.
