...
do_install() {
    ...
    # The catalog DIRECTORY ships as owned payload (hook-contract wave); the
    # catalog FILE itself is machine state the hook below generates, because
    # several packages register rewrite rules into one shared catalog.
