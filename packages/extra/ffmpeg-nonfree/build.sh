...
#
# ffmpeg-nonfree 1.0 — Opt-in installer for ffmpeg with FDK-AAC
...
ACCEPTANCE_FILE="$ACCEPTANCE_DIR/ffmpeg-nonfree-1.0-accepted.json"
...
if [ "$(id -u)" -ne 0 ]; then
    echo "ERROR: Run via 'sudo pkm install ffmpeg-nonfree' instead."
