> **⛔ SUPERSEDED 2026-07-12** — this external-designer brief predates the
> current icon direction. InterGenOS icons are **flat-color + ECG-blue glow,
> NOT glass**, and the icon corpus is now authored in-house by the IGIC icon
> compiler (campaign closed 2026-07-12). See
> [VISUAL_LANGUAGE.md](../../../../VISUAL_LANGUAGE.md) v2 §11/§13 and
> [intergen-icon-compiler-design.md](../../../../architecture/intergen-icon-compiler-design.md).
...
Review feedback: "None of these say InterGenOS. They look like they
