> **⛔ SUPERSEDED 2026-06-29** — this is a design-packet copy. The canonical,
> current spec is [docs/VISUAL_LANGUAGE.md](../../../../VISUAL_LANGUAGE.md) **v2**
> (icons are flat-color + ECG-blue glow, NOT glass). Kept only as the packet
> snapshot that was sent out; do not treat it as current.
...
## 2. Core Design Principle (visual interpretation)
