...
> **SUPERSEDED.** This was the working draft of the audit prepared for the
> shim-review submission. The canonical, maintained version is
> [`docs/grub2-cve-audit.md`](../../grub2-cve-audit.md) — refer to that
> document for the current CVE table and coverage summary. Kept here as
> historical record of the pre-submission drafting process.
