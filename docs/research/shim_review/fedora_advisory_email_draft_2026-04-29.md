...
- Any reference to internal project coordination tooling or the automated build process internals.
...
- [ ] Send from `security@intergenstudios.com` (configured as alias-to-personal-mailbox or dedicated mailbox by preference).
