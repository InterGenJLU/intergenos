...
Handles "remember that...", "what were we working on?", "forget about...". Explicit storage only — no passive fact extraction (by design: the user controls what is stored).
