...
6. "Phone-A-Friend" (Frontier/Cloud Escalation) with user-chosen provider
7. User-control-first design filter
...
3. Learning from traces — DEFERRED (complex, user-control concerns)
4. Voice — SKIPPED
