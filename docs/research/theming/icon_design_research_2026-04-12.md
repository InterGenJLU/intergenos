...
> **⛔ SUPERSEDED (decided 2026-07-09).** This April-12 research snapshot
> predates the ratified icon direction and is retained for history only — do NOT
> ground design work on it. Current authorities: `docs/VISUAL_LANGUAGE.md`
> (v2, 2026-06-29 — flat-COLOR icons + ECG-blue glow signature) and
> `docs/architecture/intergen-icon-compiler-design.md` (the IGIC compiler design).
...
Initial instinct (confirmed before research):
