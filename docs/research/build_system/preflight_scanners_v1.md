...
The principle (ratified 2026-05-12): pre-build gates **are** the reproducibility infrastructure. Framing recorded during the ratification arc: *"that's the type of thing that adds to our reproducibility effort."* The gates are infrastructure, not friction.
...
- Promoted to `scripts/preflight-*.py` 2026-05-12.
- Reproducibility-infrastructure rationale decided 2026-05-12: pre-build validate-time gates are infrastructure, not friction.
