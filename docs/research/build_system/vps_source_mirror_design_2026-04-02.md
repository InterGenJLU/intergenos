...
- Updates are INFORMATIONAL — the operator decides when to adopt them
...
- The operator reviews updates and decides when to adopt them
- Keeps the user in control: updates are advisory, never automatic

---

## Component 4: Update Adoption Workflow

When the operator decides to adopt updates:
