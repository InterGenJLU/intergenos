# InterGenOS Full Systems Audit — Part 4 of 5
# Kernel Configuration Files (Complete)
...
## 1. Universal Baseline Config: 00-universal-baseline.config

**Path:** `/mnt/intergenos/config/kernel/fragments/00-universal-baseline.config`

This config fragment contains options where 4 or more out of 5 major distributions
(Ubuntu, Arch, Fedora, Debian, openSUSE) agree on enabling. It is 3521 lines long.

```
#
# InterGenOS Universal Baseline Config Fragment
# Generated: 2026-04-06
#
# Options where 4+ out of 5 major distros agree on enabling.
# Source: Ubuntu, Arch, Fedora, Debian, openSUSE kernel configs.
#
# Arch is a trimmed laptop config — its absence does NOT mean
# an option is unimportant.
#
...
## 2. InterGenOS Overrides Config: 99-intergenos-overrides.config

**Path:** `/mnt/intergenos/config/kernel/fragments/99-intergenos-overrides.config`

These are InterGenOS-specific kernel configuration choices and niche hardware
drivers not covered by the universal baseline.
...
# --- USB ---
# USB storage MUST be built-in for USB boot without initramfs
...
**End of Part 4. Continue to Part 5 for the complete dependency graph.**
