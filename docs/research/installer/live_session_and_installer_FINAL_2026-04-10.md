...
|------|----------|-----------|
| Initramfs approach | **Custom /init script** | LFS way. ~100 lines of shell + busybox. No casper, no dracut, no mkinitcpio. Fully transparent and auditable — no hidden abstractions. |
...
- No hidden magic — every line is readable and purposeful
...
# Transparent, auditable, no hidden magic
...
| GUI installer proposal (reference) | Designed | `docs/research/GUI_Installer_Proposal/` | 1,652 |
...
- [GUI installer proposal](../GUI_Installer_Proposal/)
