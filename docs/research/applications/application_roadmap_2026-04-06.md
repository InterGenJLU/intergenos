...
**Date:** April 6, 2026
**Based on:** Flathub 2025 download stats, Snap Store data, Arch Community Survey, DistroWatch rankings, default app analysis across 6 major distributions, and a daily-use list from the development workstation.

---

## Guiding Principle

The core design principle applies to application selection: if a user expects it to be there, it should be there. A system the user can trust doesn't make them hunt for basic tools.
...
| **Timeshift** | System snapshots/backup, default in Mint, AUR favorite. User control principle: users should be able to recover from their own mistakes. | Low-Medium |
...
| **OBS Studio** | Screen recording/streaming, top Flathub, in use on the development workstation | Medium |
...
- Daily-use application list from the development workstation
