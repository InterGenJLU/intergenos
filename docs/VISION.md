...
30. ☑ Application roadmap Phase 1 — 9 install-helpers shipping (Brave, Chrome, Claude Code, Discord, Edge, Signal, Spotify, VS Code, Zoom). Steam targeted for Phase 3 (x86 binary compatibility).
