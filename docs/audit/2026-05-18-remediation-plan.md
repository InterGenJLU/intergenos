...
**Owner decisions needed.**
- **L-005 canonical publish workflow** (publish-repo.sh vs mirror-publish.sh); hostname (repo.intergenos.org vs intergenstudios.com/mirror/).
