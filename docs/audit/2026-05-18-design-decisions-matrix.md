...
| DOCS/MIRROR | Repo content discipline | InterGenOS only; NEVER PII; auth-gated endpoints OK; publicly-adopted names ("Christopher Cork", "InterGenJLU", "Ethan Bambock") explicitly OK | RATIFIED (fleet-wide) | 2026-04-23 | operator | operational rule on repo PII | — |
...
| PROCESS | Repo content = NEVER PII | Auth-gated endpoints OK; repo never | RATIFIED (fleet-wide) | 2026-04-23 | operator | operational rule | — |
