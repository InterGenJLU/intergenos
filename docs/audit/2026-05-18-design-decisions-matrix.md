...
| BOOT | UKI vs grub — installed system | `installer/backend/bootloader.py` runs grub-install + grub-mkconfig + signs `/boot/vmlinuz-*`. UKI parity not implemented. | PROPOSED | — | — | audit B-008; remediation plan decision needed | W-B12 — Class B cross-time conflict |
