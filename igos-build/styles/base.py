...
LIB32_CROSS_FILE = "/mnt/intergenos/config/lib32/lib32-cross.ini"
LIB32_ENV_SOURCE = "source /mnt/intergenos/scripts/lib32-env.sh"
...
class BuildStyle(ABC):
    ...
    def _lib32_wrap(self, pkg: Package, commands: list[str]) -> list[str]:
        ...
        if pkg.elf_class != "32":
            return commands
        return [f"{LIB32_ENV_SOURCE}; {c}" for c in commands]
