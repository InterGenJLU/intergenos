...
operator change is unnecessary. The substitution is performed manually —
see `docs/operations/01-build-vm-setup.md`. `scripts/build-vm-seed.sh`
(or an equivalent Makefile target) is planned automation and is not yet
authored.
