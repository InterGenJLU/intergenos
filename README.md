...
**Test harness.** over 600 tests in `installer/tests/` covering installer backend, MOK validation, install-integrity, and Class 1 signing-chain verification, plus over 3,700 tests across the repo-level suites under `tests/` (preflight, repo-publish, SBOM, upstream-check, download-sources, and more).
