...
GTK4/Wayland window. The math was ported verbatim from the original
canonical C source (PREVIOUSLY at the paths below; removed 2026-05-22
at commit f6b79851 per Walk D-011 / Q6 post-testing-cleanup verdict;
git history retains the C source trees, and the C/DRM reference
binary still lives on the IGOS laptop for archival side-by-side):
...
This Python file is now the surviving canonical math reference per
the build.sh coexistence-comment block + Q6 fallback-preservation
directive.

Per the decided flow ([[project_first_login_animation_flow]]):
    1. Forge runs
    2. System installs
    3. System reboots
...
Visual properties are LOCKED per the decision of 2026-05-20T~19:Z (Q5
...
# canonical answer to the decided post-login flow's "take over
...
# -------------------------------------------------------------------
# Brand constants — were ported verbatim from assets/intergen-firstboot/pulse.h
# (the C header was removed 2026-05-22 at f6b79851 per Walk D-011 / Q6 post-
# testing-cleanup; values below are now the surviving canonical math reference).
    ...
    def do_activate(self):
        ...
        try:
            ...
            if HAS_LAYER_SHELL:
                ...
                # delivers the decided "take over the screen"
