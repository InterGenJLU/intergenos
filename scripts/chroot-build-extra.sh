...
log "    sudo pkm install-helper chrome       # Google Chrome"
log "    sudo pkm install-helper vscode       # Visual Studio Code"
log "    sudo pkm install-helper claude-code  # Claude Code (CLI + extension)"
log ""
